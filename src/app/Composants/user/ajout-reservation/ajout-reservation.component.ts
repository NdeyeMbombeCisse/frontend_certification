...
//   reservationTyp
        // return this.http.get(`${apiUrl}/categories`);eSelected: boolean = false; // Pour savoir si le type de réservation a été sélectionné


//   // nouv
//   currentReservation: any = null;
//   showCurrentReservation: boolean = false;
...
// //         }).then(() => {
// //           // 
        // return this.http.get(`${apiUrl}/categories`);Rediriger vers la page de paiement après que l'utilisateur clique sur "OK"
...
//       this.showCurrentReservation = false; // Cacher la réservation actuelle
//     }
